...
DirectX::XMFLOAT2 Gauge_UI::gauge_only_position = DirectX::XMFLOAT2(106.f, 405.f);	//枠を除いたゲージ色の部分のみの位置
DirectX::XMFLOAT2 Gauge_UI::gauge_only_size = DirectX::XMFLOAT2(64.f, 420.f);		//枠を除いたゲージ色の部分のみのサイズ
