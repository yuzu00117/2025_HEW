...
static ID3D11ShaderResourceView* g_Anchor_Chain_Effect_Level1_Texture1 = NULL;//チェーンの位置に表示する
static ID3D11ShaderResourceView* g_Anchor_Chain_Effect_Level1_Texture2 = NULL;//チェーンの位置に表示する
static ID3D11ShaderResourceView* g_Anchor_Chain_Effect_Level1_Texture3 = NULL;//チェーンの位置に表示する

static ID3D11ShaderResourceView* g_Anchor_Chain_Effect_Level2_Texture1 = NULL;//チェーンの位置に表示する
static ID3D11ShaderResourceView* g_Anchor_Chain_Effect_Level2_Texture2 = NULL;//チェーンの位置に表示する
static ID3D11ShaderResourceView* g_Anchor_Chain_Effect_Level2_Texture3 = NULL;//チェーンの位置に表示する

static ID3D11ShaderResourceView* g_Anchor_Chain_Effect_Level3_Texture1 = NULL;//チェーンの位置に表示する
static ID3D11ShaderResourceView* g_Anchor_Chain_Effect_Level3_Texture2 = NULL;//チェーンの位置に表示する
static ID3D11ShaderResourceView* g_Anchor_Chain_Effect_Level3_Texture3 = NULL;//チェーンの位置に表示する
