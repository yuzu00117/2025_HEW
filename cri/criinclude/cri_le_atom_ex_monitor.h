...
#define CRIATOMEX_MONITOR_VER_NUM				"1.21.98"
#define CRIATOMEX_MONITOR_VER_MAJOR				(1)
#define CRIATOMEX_MONITOR_VER_MINOR				(21)
#define CRIATOMEX_MONITOR_VER_PATCH				(98)
...
#define CRIATOMEX_MONITOR_LOG_MODE_VOICE_VOLUME				(1 << 11)	/* ボイスボリューム */
