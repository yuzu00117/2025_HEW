	...
	:Enemy(ENEMY_STATIC_LIFE, ENEMY_STATIC_DAMAGE, ENEMY_STATIC_SPIRIT_TYPE, ENEMY_STATIC_SCORE, true, false)
{
	...
	ObjectData* sensor_data = new ObjectData{ collider_enemy_static_sensor };
...
void EnemyStatic::Update()
{
	...
	else if (!GetUse())
	{
		...
		item_manager.AddDamageValue(b2Vec2{ now_positon.x, now_positon.y - 0.2f }, b2Vec2{ 1.0f,1.0f }, 0.0f, DamageOwnerType_enemy, ENEMY_STATIC_LIFE);
